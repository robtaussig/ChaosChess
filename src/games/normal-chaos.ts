...
export default class NormalChaos extends BaseGame {
  ...
  public static description: `The standard variation of Chaos Chess. Board is
                              randomized, and each players take turns playing
                              white. Games can begin in checkmate!`;
