...
export default class RankedChaos extends BaseGame {
  ...
  public static description: `Both players begin with a currency. Instead of
                              taking turns playing as white, both players bid
                              up to 10 units an amount that they believe
                              reflects the advantage of white, the first to move.
                              The lowest bid takes control of white, and both bids
                              are placed into a pot to be paid out to the winner.
                              If both players bid the max amount, a new random
                              board is generated.`;
